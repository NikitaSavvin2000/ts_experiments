...
print(f"columns = {df_ts_t2v.columns}")

columns_to_test = ['Datetime', 'consumption', 'day',
 'day_of_week', 'hour', 'minute', 'hour_sin']

df_ts_t2v = df_ts_t2v[columns_to_test]
...
df_real_pred_t2v = df_real_pred_t2v[columns_to_test]
...
df_test_pred = Transformer_forecast(
    col_target=col_target,
...
df_real_pred = Transformer_forecast(
    col_target=col_target,
    time_column=col_time,
    df_train=df_ts_t2v,
