"""
pdm run src/ts_models/TimesFM_service/runners.py
...
from src.ts_models.TimesFM_service.TimesFM_pred import TimesFM_forecast
...
src/ts_models/NLinear_service/runners.py